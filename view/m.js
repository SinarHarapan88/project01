...
(function(){
  ...
  try{
    ...
    if (_JSAPI){
      ...
      verel.innerHTML="<b>Anime Movie "+_JSAPI.getVersion(0)+" "+
        "&copy; 2024-2025 DummyXXX</b><br />";
    }
  }catch(e){}
...
//      }
//      verel.innerHTML="<b>Anime Movie "+_JSAPI.getVersion(0)+" "+
//        "&copy; 2024-2025 DummyXXX</b><br />Build "+_JSAPI.getVersion(1)
    ...
    if (c==KBACK){
      if (pr==0){
        if (home.header_items_selected==0){
          // EXIT MODE
          var em=toInt(_JSAPI.storeGet("exitmode","1"));
          clk();
          if (em==0){
            _JSAPI.appQuit();
          }
